...
| C2 | Evidence is entirely synthetic | Valid and the main external-validity weakness. | major | ACCEPT_EXPERIMENT | P3-v1 CPU construct gate failed; no inference | Preserve the adverse pilot and seek separate owner-reviewed P3-v2 design or report this limitation; semi-synthetic contexts cannot be described as real causal validation. |
