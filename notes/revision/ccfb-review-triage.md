...
| C2 | Evidence is entirely synthetic | Valid and the main external-validity weakness. | major | ACCEPT_EXPERIMENT | P3-v1 CPU gate failed; P3-v2 design candidate awaiting owner review | Preserve the adverse pilot; v2 holds out its source IDs and retains the gate. Neither semi-synthetic test is real-covariate causal validation. |
