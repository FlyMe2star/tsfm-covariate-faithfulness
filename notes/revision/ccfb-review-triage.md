...
| C2 | Evidence is entirely synthetic | Valid and the main external-validity weakness. | major | ACCEPT_EXPERIMENT | P3 design candidate awaiting owner review; no inference | Semi-synthetic contexts must be separately frozen before model access and cannot be described as real causal validation. |
